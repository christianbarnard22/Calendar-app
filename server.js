...
app.get("/api/getList", (req, res) => {
  ...
  var filteredData = data.filter(function(item) {
    var launchDate = new Date(item.launch_date);
    var launchDateTime = getTime(launchDate);
    var check = launchDateTime > start && launchDateTime < finish;
    return check;
  });
